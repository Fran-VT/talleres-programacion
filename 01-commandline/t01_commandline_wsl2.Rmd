...
-n	Entrega el numero de lineas que contienen el patrón
-r	Busca dentro de directorios de manera recursiva
...
--color	los match se devuelven en color dentro de la terminal
