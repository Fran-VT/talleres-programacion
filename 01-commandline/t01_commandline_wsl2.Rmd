...
- **Terminal** es la consola de comandos, con la cual interactuamos mediante pulsos de teclado. 
    - **Shell**
        - **Kernel**
...
En la mayor parte de las distros ya viene preinstalado. Sino, se puede instalar siguiendo esta [guia]() # TODO: poner link a guia de git. 


```bash
git version # muestra la versión del archivo
```
```
