...
date: '2020-11-26',
author: "Alejandro Acevedo-Aracena, _PhD_^[_FONDECYT Postdoctoral Fellow_, Universidad de Chile, deepen.data@gmail.com]; Manuel Muñoz-González^[_Pregrado_, Universidad de Chile]", output: {html_document: {theme: flatly, highlight: tango, toc: true, toc_float: {collapsed: false, smooth_scroll: true}, df_print: paged}, html_notebook: default}}
---
...
Por ejemplo, ``cat <archivo.fasta> | grep -c "ATG"`` esto abrira `<archivo.fasta>`, 
y luego buscara el patron ATG o codon start, 
contara la frecuencia y retornara el numero de matches.
...
### Ejemplo WC 
<!-- TODO: Qué pasa con este ejemplo? -->
